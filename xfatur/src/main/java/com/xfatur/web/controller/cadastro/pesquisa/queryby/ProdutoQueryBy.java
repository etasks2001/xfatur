...
public class ProdutoQueryBy implements QueryBy<ProdutoView> {
    ...
    private static final String[] COLUMNS = new String[] { "id", "codigoProduto", "codigoDeBarras", "descricao", "unidadedetalhada", "graduacaoAlcoolica", "cest", "ipiunitario", "aliquotaipi", "pais",
	    "produtor", "marca", "regiaoProdutora", "pesoLiquido", "pesoBruto", "larguraDaCaixa", "comprimentoDaCaixa", "tipoValidade" };
    @Autowired
