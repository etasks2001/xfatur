...
//	destinatario.setNaturezajuridica_id(3);
	...
	public static Stream<ClassificacaoFiscal> classificacaoFiscalList() {
		...
		return Stream.of(createClassificacaoFiscal1(), createClassificacaoFiscal2(), createClassificacaoFiscal3(), createClassificacaoFiscal4(), createClassificacaoFiscal5(), createClassificacaoFiscal6());
	}
	...
	public static Stream<Tributacao> tributacaoList() {
		return Stream.of(
				...
				createTributacao1(), createTributacao2(), createTributacao3(), createTributacao4(), createTributacao5(), createTributacao6(), createTributacao7(), createTributacao8(), createTributacao9(), createTributacao10(), createTributacao11());
	}
	...
	public static Stream<TipoItem> tipoList() {
		return Stream.of(createTipo1(), createTipo2(), createTipo3(), createTipo4(), createTipo5(), createTipo6(), createTipo7(), createTipo8(), createTipo9(), createTipo10(), createTipo11(), createTipo12());
	}
